...
/* USER CODE BEGIN PV */
volatile int16_t offset_ch1 = 0;
uint8_t current_state = 0;
volatile float current_display = 0;
/* USER CODE END PV */
...
int main(void)
{
  ...
  MX_I2C1_Init();
  /* USER CODE BEGIN 2 */
  // 1. Khởi tạo State Machine và các Module ngoại vi
    FSM_Init();
    AD7606_Init();
    offset_ch1 = AD7606_Calibrate_Offset_CH1(5000);
    PWM_Init();
    RS485_Init(&huart1);
    lcd_init();
    ...
    // 3. (Tuỳ chọn) Bật nhận Modbus DMA tại đây...
  /* USER CODE END 2 */
